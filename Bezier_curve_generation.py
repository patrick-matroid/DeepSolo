...
labels = glob.glob('rename_total_images_train_labels/*.txt')
labels.sort()

for il, label in enumerate(labels):
    print('Pros '+label)
    imgdir = label.replace('rename_total_images_train_labels/', 'rename_total_images_train/').replace('.txt', '.jpg')
